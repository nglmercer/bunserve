// Función para comparar si dos objetos tienen exactamente las mismas claves
...
// Interfaz para los parámetros de filterRequiredFields
interface FilterParams {
    required: string[] | Record<string, any>;
    actualObj: Record<string, any>;
}

// Función para filtrar campos requeridos de un objeto
...
// Interfaz para las opciones de validación
interface ValidateOptions {
    types?: Record<string, string>;
    validators?: Record<string, (value: any) => boolean>;
}

// Interfaz para los parámetros de validateFields
...
// Función para validar campos según requisitos y opciones
